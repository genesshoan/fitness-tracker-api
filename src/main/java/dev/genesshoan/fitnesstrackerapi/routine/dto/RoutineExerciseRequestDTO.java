...
public record RoutineExerciseRequestDTO(
        ...
        @NotNull(message = "Default sets is required")
                ...
                Integer defaultSets,
        @Schema(description = "Default number of reps", example = "10") Integer defaultReps,
        @Schema(description = "Default weight in kg", example = "50") Double defaultWeightKg,
        @Schema(description = "Default duration in seconds", example = "60") Integer defaultDurationSeconds,
        @Schema(description = "Default distance in km", example = "5.0") Double defaultDistanceKm,
