...
public record RoutineExerciseResponseDTO(
        ...
        @Schema(description = "The exercise's position", example = "1")
        int position,

        @Schema(description = "The exercise's default rest seconds", example = "60")
        int defaultRestSeconds,

        @Schema(description = "The exercise's default sets", example = "3")
        int defaultSets,

        @Schema(description = "The exercise's default reps", example = "10")
        Integer defaultReps,

        @Schema(description = "The exercise's default weight in kilograms", example = "100.0")
        ...
        @Schema(description = "The exercise's notes", example = "")
        String notes) {}
