...
public class ValidationExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleMethodArgumentNotValidException(
        ...
        Map<String, List<String>> errors =
                groupErrors(ex.getFieldErrors(), FieldError::getField, FieldError::getDefaultMessage);

        ProblemDetail problemDetail = errorResponse(
                HttpStatus.BAD_REQUEST, "Validation failed", "One or more fields are invalid", errors, request);
